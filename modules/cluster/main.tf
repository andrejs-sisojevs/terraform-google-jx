...
data "template_file" "kubeconfig" {
  ...
  vars = {
    cluster_name    = google_container_cluster.jx_cluster.name
    user_name       = google_container_cluster.jx_cluster.master_auth[0].username
    user_password   = google_container_cluster.jx_cluster.master_auth[0].password
    endpoint        = google_container_cluster.jx_cluster.endpoint
    cluster_ca      = google_container_cluster.jx_cluster.master_auth[0].cluster_ca_certificate
    client_cert     = google_container_cluster.jx_cluster.master_auth[0].client_certificate
    client_cert_key = google_container_cluster.jx_cluster.master_auth[0].client_key
  }
}
